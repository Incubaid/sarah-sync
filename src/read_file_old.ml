(* Reading of file, with IO from Pervasives *)
...
(* Returns a list of blocks of the file.
   The blocks all have the same size, except maybe the first one. *)
...
(* Returns file split on whitespace, with blocks of approximately a given size *)
